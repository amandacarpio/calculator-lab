...
//put in a route called calquery takes in 2 parameters and a query for opertation

app.get("/calquery/:numOne/:numTwo",(request, response) => {
    // // console.log(
    //     request.params.numOne, 
    //     request.params.numTwo, 
    //     `the object type of ${request.params.numOne} which is on the URL is ${}`,
    // )
    // anything type inside the URL will always be a string
...
// request.params - can add more keys to the request.params object - these are added following a /:keyname
// request.query - anything added after the ? - it will always be a key=value - you can add more than 1 by using & in between